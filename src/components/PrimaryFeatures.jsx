...
const features = [
  {
    ...
    description:
      'Restrict content with web3 ownership. Make it so that only certain communities, NFT or token holders can see the files you share.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: '3D capture for anyone',
    description:
      'LiDAR scanning and photogrammetry made easy. Create instant, accurate 3D models of absolutely anything and convert them to a replica NFT straight from your mobile.',
  ...
  },
  {
    name: 'Web3 Rewards',
    description:
      'Get tokens and NFT rewards for taking back control of your data. These rewards are interoperable and owned by you and you alone.',

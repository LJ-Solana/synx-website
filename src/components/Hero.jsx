...
export function Hero() {
  return (
    <div className="overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36 bg-black">
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 bg-black lg:gap-y-20">
          ...
          <div className="relative mt-10 sm:mt-20 lg:col-span-5 lg:row-span-2 bg-black lg:mt-0 xl:col-span-6">

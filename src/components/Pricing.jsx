    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          <h2
            id="pricing-title"
            className="text-3xl font-medium font-bold tracking-tight text-gray-900"
          >
            Simple, no b*llsh*t pricing.
          </h2>
          <p className="mt-2 text-lg text-gray-600">
            Whether you’re one person trying to take back control or a big firm trying
            to archive data effectively over the world, we’ve got a plan for you.
          </p>
        </div>
